    ...
    return(
        <>  
            <div className="grid grid-cols-4 ">
                <div className="group mr-2 w-10 md:w-12 items-center justify-center">
                    <a href='tel:+919829458909' className="relative cursor-pointer">
                        ...
                        <span className="relative overflow-hidden bg-skin-primary-shade rounded-full">
                            ...
                            <label className="absolute h-full w-full text-sm font-normal flex items-center justify-center -bottom-10 group-hover:bottom-10 md:group-hover:bottom-16 opacity-0 group-hover:opacity-100">+918000780260</label>
                        </span>
                    </a>
                </div>
                ...
                <div className="group mr-2  w-10 md:w-12 items-center justify-center">
                    <a href='mailto:hello@adsrebel.com' className="relative cursor-pointer">
                        ...
                        <span className="relative overflow-hidden bg-skin-primary-shade rounded-full">
                            ...
                            <label className="absolute h-full w-full text-sm font-normal flex items-center justify-center -bottom-10 group-hover:bottom-10 md:group-hover:bottom-16 opacity-0 group-hover:opacity-100">hello@adsrebel.com</label>
                        </span>
                    </a>
                </div>

                <div className="group mr-2  w-10 md:w-12 items-center justify-center">
                    <a href='https://instagram.com/adsrebel_advertising' className="relative cursor-pointer">
                ...
                <div className="group mr-2  w-10 md:w-12 items-center justify-center">
                    <a href='https://www.linkedin.com/company/adsrebel' className="relative cursor-pointer">
